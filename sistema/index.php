			...
			<div>
				...
				<div class="containerPerfil">
					...
					<form action="" method="post" name="frmChangePass" id="frmChangePass">
						...
						<div>
							<button type="submit" class="btn_save btnChangePass"><i class="fas fa-key"> Cambiar contraseÑa</i></button>
						</div>
					</form>
				</div>
				<?php 	
				...
				?>
					<div class="containerDataEmpresa">
						...
						<div>
							<label>Teléfono:</label><input type="text" name="txtTelEmpresa" id="txtTelEmpresa" placeholder="Teléfono de la empresa" value="<?= $telEmpresa; ?>" required>
						</div>
						<div>
							<label>Correo electrónico:</label><input type="email" name="txtEmailEmpresa" id="txtEmailEmpresa" placeholder="Correo electrónico de la empresa" value="<?= $emailEmpresa; ?>" required>
						</div>
						<div>
